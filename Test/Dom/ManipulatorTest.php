...
class ManipulatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testArrayDom()
    {
        ...
        $this->assertEquals('<en><head><meta charset="utf-8"><title>My awesome array website :)</title><link rel="stylesheet" href="common.css"></head><body><h1>Welcome to Tale DOM!</h1><p class="first">This shit is really fucking awesome.</p><p class="second">I\'m awesome!</p><p class="third">You\'re awesome!</p><table><tr class="tr-1"><th class="th-1">Col 1</th><th class="th-2">Col 2</th><th class="th-3">Col 3</th></tr><tr class="tr-2"><td class="td-1">Cell 1</td><td class="td-2">Cell 2</td><td class="td-3">Cell 3</td></tr><tr class="tr-3"><td class="td-1">Cell 4</td><td class="td-2">Cell 5</td><td class="td-3">Cell 6</td></tr></table></body></en>', (string)$m);
    }
}